...
const SECTIONS = [
  {
    ...
    items: [
      { label: "School Hours", value: "8:00 AM – 4:30 PM (Monday to Saturday)" },
      { label: "Gates Open", value: "7:45 AM (students should arrive by 7:55 AM)" },
      { label: "Prayer Assembly", value: "8:00 AM (mandatory for all students)" },
      { label: "Lunch Break", value: "12:30 PM – 1:15 PM" },
      { label: "School Closes", value: "4:30 PM (transport departs at 4:45 PM)" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Late Arrivals", value: "Students arriving after 8:10 AM will be marked late" },
      { label: "Leave Application", value: "Written application required from parent/guardian" },
      { label: "Medical Leave", value: "Doctor's certificate required for 3+ consecutive days" },
  ...
  },
  {
    ...
    color: "border-gold",
    items: [
      { label: "School Uniform", value: "Mandatory on all school days. Available at the school office." },
      ...
      { label: "Jewellery", value: "Only small studs/earrings for girls. No other jewellery permitted." },
      { label: "Mobile Phones", value: "Not permitted on school premises (exceptions for Class X during exams with permission)" },
    ],
  },
  {
    id: "conduct",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Payment Methods", value: "Cash at school office or bank transfer (account details at admission)." },
      ...
      { label: "Concessions", value: "Available for siblings and economically weaker sections (apply at office)." },
    ],
  },
];
