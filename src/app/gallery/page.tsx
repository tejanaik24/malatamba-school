...
const PAGE_URL = "https://www.malatambavidyaniketan.ac.in/gallery";
const PAGE_TITLE = "Photo Gallery";
const PAGE_DESC =
  "Photo gallery of Malatamba Vidyaniketan — annual day, sports events, cultural celebrations, and school life in Visakhapatnam.";
...
const EVENTS = [
  { folder: "school-life-2026", name: "School Life 2026",     cover: "mar16-01.webp" },
