...
const facilities = [
  {
    ...
    image: "/ai-images/values-discipline.webp",
  ...
  },
  {
    ...
    highlights: ["Physics Lab", "Chemistry Lab", "Biology Lab", "40-seat Computer Lab"],
    image: "/ai-images/feature-lab.webp",
  ...
  },
  {
    ...
    desc: "Our well-stocked library houses over 3,000 books, reference materials, newspapers, and magazines. The dedicated reading room cultivates a love for books and research, supporting students from all grades.",
    highlights: ["3,000+ Books", "Reference Section", "Reading Room", "Daily Newspapers"],
    image: "/ai-images/highlights-library.webp",
  ...
  },
  {
    ...
    highlights: ["Cricket Ground", "Football Field", "Athletics Track", "Indoor Games", "Outdoor Games", "Throw Ball", "Volleyball"],
    image: "/ai-images/highlights-sports.webp",
  ...
  },
  {
    ...
    desc: "Our fleet of school buses covers all major routes across Visakhapatnam. With trained drivers, male and female attendants on every bus, and strict safety protocols, parents can trust their children are in safe hands.",
    highlights: ["Male & Female Attendants", "City-Wide Routes", "Trained Drivers", "Safe Transport"],
    image: "/ai-images/feature-sports.webp",
  ...
  },
  {
    ...
    highlights: ["Auditorium Stage", "Art Room", "Music Room", "Landscaped Grounds", "Yoga Room", "Library Room", "Conference Room", "Digital Classroom"],
    image: "/ai-images/highlights-cultural.webp",
